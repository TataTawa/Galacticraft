...
public class EnergyNetwork implements IElectricityNetwork {
    ...
    /*
     * connectedAcceptors is all the acceptors connected to this network connectedDirections is the directions of those connections (from the point of view of the acceptor tile) Note: each position in those two linked lists matches so, an acceptor
     * connected on two sides will be in connectedAcceptors twice
     */
    ...
    /*
     * availableAcceptors is the acceptors which can receive energy (this tick) availableconnectedDirections is a map of those acceptors and the directions they will receive from (from the point of view of the acceptor tile) Note: each acceptor will
     * only be included once in these collections (there is no point trying to put power into a machine twice from two different sides)
     */
     ...
     *
     * @param ignoreTiles
     *            Tiles to ignore in the request calculations (NOTE: only used in initial (internal) check.
     ...
     *
     * @param energy
     *            Amount of energy to send into the network
     * @param doReceive
     *            Whether to put energy into the network (true) or just simulate (false)
     * @param ignoreTiles
     *            TileEntities to ignore for energy transfers.
