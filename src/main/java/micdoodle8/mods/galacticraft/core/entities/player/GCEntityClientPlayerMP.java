...
public class GCEntityClientPlayerMP extends EntityPlayerSP {
    ...
    public GCEntityClientPlayerMP(Minecraft mcIn, World worldIn, NetHandlerPlayClient netHandler, StatisticsManager statFileWriter, RecipeBook p_i47378_5_) {
        super(mcIn, worldIn, netHandler, statFileWriter, p_i47378_5_);
    }
    ...
    /*
     * @Override public void setInPortal() { if (!(this.world.provider instanceof IGalacticraftWorldProvider)) { super.setInPortal(); } } TODO Fix disable of portal
     */
