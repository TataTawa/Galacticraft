...
public class GuiDeconstructor extends GuiContainerGC
{
    ...
    public void initGui()
    {
        ...
        this.electricInfoRegion.y = (this.height - this.ySize) / 2 + 95;
        ...
        this.processInfoRegion.x = (this.width - this.xSize) / 2 + 53;//77
        this.processInfoRegion.y = (this.height - this.ySize) / 2 + 28;//30
